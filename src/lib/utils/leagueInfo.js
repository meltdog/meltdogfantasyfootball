...
export const homepageText = `
  <p>Meltdog Fantasy Football was founded in 2022 as a 12-man fantasy football league built around competition, friendship, and an unhealthy commitment to making fantasy football matter far more than it probably should. Four seasons later, MFF has developed a history all its own—championship dynasties, spectacular collapses, bitter rivalries, infamous trades, league punishments, running jokes, and the kind of moments that refuse to die in the group chat.</p>
  <p>What began as a fantasy league has gradually turned into something closer to its own sports universe. Every season adds another chapter to a growing archive of records, matchups, playoff runs, awards, transactions and manager legacies. Some members have established themselves as champions, others as perennial contenders, and a few have managed to become famous for entirely different reasons.</p>
  <p>The MFF website exists to preserve all of it. From the first season to whatever comes next, this is the permanent record of the league—the good teams, the terrible teams, the heartbreak, the trash talk and the stories that have made Meltdog Fantasy Football what it is.</p>
`;
